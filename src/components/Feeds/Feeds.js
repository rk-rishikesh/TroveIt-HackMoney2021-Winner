...
class Feeds extends Component {
  ...
  async loadWeb3() {
    if (window.ethereum) {
      biconomy = new Biconomy(window.ethereum, {
        apiKey: "GmWNyq8kr.8729384c-dac2-4156-aca6-ac4208761300",
      });
  ...
  async loadBlockchainData() {
    biconomy
      .onEvent(biconomy.READY, async () => {
        ...
        if (networkData) {
          const troveIt = new web3.eth.Contract(
            TroveIt.abi,
            networkData.address
          );
  ...
  likeFeedPost(feedId, originalPostId) {
    ...
    console.log("Like Feed & Original Post");
                      ...
                      <div className="card mb-4" key={key}>
                        ...
                        >
                          <li className="list-group-item">
                            <p class="text-center">
                              <img
                                src={`https://ipfs.infura.io/ipfs/${feedPost.hash}`}
